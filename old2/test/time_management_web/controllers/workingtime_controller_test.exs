defmodule TimeManagementWeb.WorkingtimeControllerTest do
  ...
  @update_attrs %{
    end: ~U[2021-10-26 10:27:00Z],
    start: ~U[2021-10-26 10:27:00Z]
  }
  ...
  describe "create workingtime" do
    test "renders workingtime when data is valid", %{conn: conn} do
      ...
      assert %{
               "id" => ^id,
               "end" => "2021-10-25T10:27:00Z",
               "start" => "2021-10-25T10:27:00Z"
  ...
  describe "update workingtime" do
    ...
    test "renders workingtime when data is valid", %{conn: conn, workingtime: %Workingtime{id: id} = workingtime} do
      ...
      assert %{
               "id" => ^id,
               "end" => "2021-10-26T10:27:00Z",
               "start" => "2021-10-26T10:27:00Z"
             } = json_response(conn, 200)["data"]
    end
